...
<div align="center">
  ...
  <a href="https://twitter.com/Superionix">
...
| **Backend & Core** | **Frontend & UI** | **DevOps & Tools** |
|:---:|:---:|:---:|
| <img src="https://skillicons.dev/icons?i=nestjs,nodejs,java,express" /> | <img src="https://skillicons.dev/icons?i=astro,ts,html,tailwind" /> | <img src="https://skillicons.dev/icons?i=docker,mongo,git,linux,nginx,postman" /> |
...
| :--- | :--- | :--- |
| **🛒 API E-commerce** | `NestJS` `JWT` `Jest` | Microservicios escalables, autenticación segura y cobertura de tests unitarios. |
| **🏙️ Portal Comunitario** | `WordPress` `Astro` `PHP` | Headless CMS con frontend estático de alto rendimiento y pasarela de pagos. |
